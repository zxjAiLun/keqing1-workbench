...
def test_ladder_eligibility_blocks_non_promoted_and_retired_artifacts(
    ...
    seats = [
        ...
        MatchSeat(seat=1, account_id="ai@01", controller_type="local_model", model_artifact_id=art_id),
        MatchSeat(seat=2, account_id="ai@02", controller_type="local_model", model_artifact_id=art_id),
        MatchSeat(seat=3, account_id="ai@03", controller_type="local_model", model_artifact_id=art_id),
    ]
